    ...
    return (
        ...
        <div id="about" className="mt-5">
            <Card dataAos="fade" className="">
                ...
                <p><span className="text-[24px] font-bold">Abdullahi Mohammed -</span> <span>A Full-Stack Web Developer</span></p>
                <p>I am committed to developing high-quality websites that’s responsive from desktop to mobile screens that align with your brand identity, user experience goals and industry standards.</p>
            </Card>
            ...
            <ul className="mt-5 flex flex-col md:flex-row justify-between items-center gap-10">
                ...
                <li className="flex-1">
                    <Card className="py-8">
                        ...
                        <p className="px-2 py-1 rounded-md bg-[#9410D2] w-fit mt-4 mb-1
                        ...
                        <p className="px-2 py-1 rounded-md bg-[#9410D2] w-fit my-1 ml-auto mr-[10%]">And get a Quote</p>
                    </Card>
                </li>
            </ul>
        </div>
