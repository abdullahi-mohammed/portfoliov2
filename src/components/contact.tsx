    ...
    return (
        <section id="contact" className="mt-10 md:mt-20">
            ...
            <ul className="flex flex-wrap gap-5 mt-5">
                ...
                <li><a href="https://twitter.com/abdullahimoh_d" target="_blank">
